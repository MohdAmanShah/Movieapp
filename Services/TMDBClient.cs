...
namespace MovieApp.Services
{
    public class TMDBClient
    {
        ...
        public Task<PopularMoviePagedResponse?> GetSearchedMovie(string query,int page = 1)
        {
            return _httpClient.GetFromJsonAsync<PopularMoviePagedResponse>($"search/movie?query={query}&page={page}");
        }
    }
}
